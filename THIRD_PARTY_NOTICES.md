...
SQLite and other runtime notices provided with Python remain applicable. Windows PowerShell and .NET are used from the host, not distributed in the package. Build tools and GitHub Actions are not part of the application's source license.
